...
const TechNews = () => {
    ...
    const apicall=()=>{
        axios.get(
"https://newsapi.org/v2/top-headlines?sources=techcrunch&apiKey=13b9918bbc434a59a4e672d5038b5b77"
  ...
  return (
    ...
    <h2 className="text-center mb-4">Tech Crunch News List</h2>
          ...
          <div key={index} className="col-lg-3 col-md-6 col-sm-12 mb-3">
            <div className="card shadow-sm h-100">
              ...
              <div className="card-body">
                ...
                <a href={value.url}  className="card-link">{value.description.length > 50 ? value.description.slice(0, 50) + "..." : value.description || "No description available."}</a>
